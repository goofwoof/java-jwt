...
public final class JWTCreator {
    ...
    public static class Builder {
         ...
         *                                  or there was a problem with the signing key.
         */
        public String sign(Algorithm algorithm, boolean urlEncoder) throws IllegalArgumentException,
    ...
    private String sign(boolean urlEncoder) throws SignatureGenerationException {
        ...
        String header = encoder.withoutPadding()
            .encodeToString(headerJson.getBytes(StandardCharsets.UTF_8));
        String payload = encoder.withoutPadding()
            .encodeToString(payloadJson.getBytes(StandardCharsets.UTF_8));

        byte[] signatureBytes = algorithm.sign(header.getBytes(StandardCharsets.UTF_8),
            payload.getBytes(StandardCharsets.UTF_8));
        String signature = encoder.withoutPadding().encodeToString((signatureBytes));
